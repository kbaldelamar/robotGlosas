...
class GlosasStatsTable(QTableWidget):
    """
    Tabla para mostrar estadísticas de cuentas de glosas.
    """
...
class GlosasWidgetUpdated(QWidget):
    """
    Widget actualizado para la gestión de glosas con nueva funcionalidad.
    """
    ...
    def create_control_group(self) -> QGroupBox:
        ...
        group = QGroupBox("Control de Automatización de Glosas")
        layout = QHBoxLayout(group)
        
        # Botón de inicio
        self.start_button = QPushButton("Iniciar Automatización de Glosas")
    ...
    def create_progress_group(self) -> QGroupBox:
        ...
        # Etiqueta de estado
        self.status_label = QLabel("Listo para iniciar automatización de glosas")
    ...
    def on_automation_finished(self, success: bool):
        ...
        # Actualizar datos después de la automatización
        self.refresh_data()
